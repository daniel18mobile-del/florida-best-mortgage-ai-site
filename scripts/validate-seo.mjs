...
if (!existsSync(join(dist, 'sitemap.xml'))) failures.push('Missing sitemap.xml');
...
if (!robots.includes('Sitemap: https://floridabestmortgage.com/sitemap.xml')) failures.push('robots.txt missing sitemap.xml directive');
